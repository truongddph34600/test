<?php
	...
	$sql23="select * from khachhang where MaKH=(select MaKH from hoadonmomo where MaHD='$mahd') ";
...
<div class="container-fluid">
	<div class=" alert alert-primary">
	  <h4 class="page-title">
	    ...
	    </span> ADMIN - BeeHat &#160;<i class="fas fa-chevron-right" style="font-size: 18px"></i>&#160; Đơn Đặt Hàng MoMo</h4>
	</div>
	<br>
