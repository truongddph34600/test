...
<div class="container-fluid py-4">
    ...
    <div class="card animate-in">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="?action=khachhang&view=them" class="btn btn-add">
            ...
            <div class="table-responsive">
                <table id="employeeTable" class="table table-hover employee-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><strong><?php echo $row['MaKH']; ?></strong></td>
                            <td>
                                <div class="employee-info">
                                    <div class="name"><?php echo $row['TenKH']; ?></div>
                                </div>
                            </td>
                            <td>
...
$(document).ready(function() {
    ...
    $('.btn-delete-confirm').on('click', function(e) {
        ...
        Swal.fire({
            title: 'Xác nhận xóa?',
            text: "Bạn có chắc chắn muốn xóa người này không?",
            icon: 'warning',
