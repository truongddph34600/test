        ...
        <div class="col-lg-10">
            <div class="form-container">
                <div class="card-header d-flex justify-content-between align-items-center mb-4">
                    <span><i class="fas fa-user-plus me-2"></i>Thêm Khách Hàng Mới</span>
                </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div>
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="tenkh" name="tenkh" placeholder="Nguyễn Văn A" required autofocus>
                            </div>
                        </div><hr>
